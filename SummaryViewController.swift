...
class SummaryViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        // Menghubungkan heroTableView dengan ke dua metode di bawah
          ...
          summaryTableView.register(UINib(nibName: "SummarysTableViewCell", bundle: nil), forCellReuseIdentifier: "suma")
        }
...
extension SummaryViewController : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        // Digunakan untuh menghubungkan cell dengan identifier "HeroCell"
           if let cell = tableView.dequeueReusableCell(withIdentifier: "suma", for: indexPath) as? SummarysTableViewCell {
               
               // Menetapkan nilai hero ke view di dalam cell
            let summary = summaries[indexPath.row]
            cell.nomor.text = summary.numLabel
            cell.judul.text = summary.summaryTitle
